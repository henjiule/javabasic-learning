...
public class Example4_5 {
    public static void main(String args[]) {
        ...
        System.out.println("main方法中circle:"+circle.getRadius());
        System.out.println("但是不影响circular圆锥bottom的引用");
        System.out.println("circular圆锥bottom的引用:"+circular.bottom);
        System.out.println("圆锥的bottom的半径:"+circular.getBottomRadius());
    }
}